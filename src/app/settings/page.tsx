      ...
      <div className="bg-card rounded-2xl shadow-sm border border-border divide-y divide-border">
        ...
        <div className="p-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 w-full mt-4 sm:mt-0">
            {([
              { id: 'default', name: 'Mạch Điện (J.A.R.V.I.S)', color: 'bg-amber-500' },
              { id: 'pastelpink', name: 'Hoa Anh Đào', color: 'bg-[#FFC0CB]' },
              { id: 'slate', name: 'Mưa Sao Băng', color: 'bg-slate-500' },
              { id: 'limegreen', name: 'Ma Trận (Matrix)', color: 'bg-[#32CD32]' },
              { id: 'orangered', name: 'Lò Rèn (Tàn Lửa)', color: 'bg-[#FF4500]' },
              { id: 'whitesmoke', name: 'Mây Khói Bí Ẩn', color: 'bg-[#F5F5F5] border border-gray-300' },
              { id: 'amethyst', name: 'Dải Ngân Hà', color: 'bg-[#9966CC]' },
              { id: 'spring', name: 'Mùa Xuân (Bướm Lượn)', color: 'bg-[#ec4899]' },
              { id: 'summer', name: 'Mùa Hè (Đom Đóm)', color: 'bg-[#06b6d4]' },
              { id: 'autumn', name: 'Mùa Thu (Lá Phong)', color: 'bg-[#f97316]' },
              { id: 'winter', name: 'Mùa Đông (Bão Tuyết)', color: 'bg-[#bae6fd]' },
              { id: 'vietnam', name: 'Việt Nam (Sao Vàng)', color: 'bg-[#ef4444]' },
            ] as const).map(t => (
              <button
                key={t.id}
