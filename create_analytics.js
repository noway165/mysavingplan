...
const dir = 'E:/my-savings-plan/src/app/analytics';
...
fs.writeFileSync('E:/my-savings-plan/src/app/analytics/page.tsx', pageContent);
console.log("Analytics page created successfully");
